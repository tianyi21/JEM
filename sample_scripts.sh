...
##                                    specify --logpset
##                      ood:         
##                              plot histogram for comparison between two sets
##                                    specify --rset for train set
##                                            --fset for "fake", i.e., the one compared to --rset
## split_dict:  set split dict in training
## set n_classes, backbone, arch, num_block accordingly to the training params

## logp_hist example
python eval_wrn_ebm.py --dataset ~/Desktop/pbmc_filtered.pkl --n_classes 11 --backbone mlp --arch 500 200 --logpset test+ood --split_dict ./experiment/set_split_idx_ood_1.pkl --eval OOD

## ood example
## default --eval is ood, default --rset is train, default --fset is test+ood
python eval_wrn_ebm.py --dataset ~/Desktop/pbmc_filtered.pkl --n_classes 11 --backbone mlp --arch 500 200 --logpset test+ood --split_dict ./experiment/set_split_idx_ood_1.pkl
